...
def add_action_to_stack(action_stack,
    ...
    :param operation_type: The type of the operation, which could be a filter, an enhancement, etc.
    :param selectedData: The JSON object that contains the zone selected by the user in which the operation is applied
...
def update_graph_interactive_image(content,
    ...
    # Retrieve information saved in storage, which is a dict containing information about the image and its action stack
